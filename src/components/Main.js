...
export default function Main() {
  return (
    <main className="relative bg-[url('../../out/mainMobile.jpg')] md:bg-[url('../../out/mainvet.jpg')] bg-no-repeat bg-cover bg-center flex flex-col gap-8 items-center py-36 px-16 main-with-overlay z-1 text-white">
